# N64 Pico Cart Reader V2 Enclosure

This directory contains the 3D printable enclosure files for the N64 Pico Cart Reader V2.
...
- **Layer Height:** 0.2mm is recommended for a good balance of quality and print speed.
- **Infill:** 15-20% is typically sufficient for an enclosure.

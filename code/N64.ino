...
static const char* const menuOptionsN64[] PROGMEM = {n64MenuItem1, n64MenuItem2, n64MenuItem3, n64MenuItem4, modeItem6, n64MenuItem5};
...
static const char* const romOptionsN64[] PROGMEM = {N64RomItem1, N64RomItem2, N64RomItem3, N64RomItem4, N64RomItem5, N64RomItem6, modeItem7};
...
void verifyMPK() {
  ...
  if (writeErrors == 0) {
    ...
    print_Msg(writeErrors);
    println_Msg(F(" bytes "));
    print_Error(F("did not verify. Trying again..."), false);
    rewriteMPK();
    verifyMPK();
  }
}
...
void idCart() {
  ...
  for (unsigned int i = 0; i < 20; i++) {
      displayName[i] = char(sdBuffer[0x20 + i]);
  }

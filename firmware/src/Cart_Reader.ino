...
void aboutScreen() {
  display_Clear();
  println_Msg(F("Nintendo 64 Cartridge Reader"));
  println_Msg(F("github.com/jgazeley"));
  println_Msg(F(""));
  println_Msg(F("Based on the Open Source Cartridge Reader by sanni"));
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("");
  Serial.println(F("Nintendo 64 Cartridge Reader"));
  Serial.println(F("https://github.com/jgazeley/n64cartreader/"));
  // LED Error

...
1. Open the Web UI; it attempts to load `host-tools/web/n64.txt`.
2. If the browser blocks automatic local-file loading, drop the `n64.txt` file onto the catalog drop zone.
